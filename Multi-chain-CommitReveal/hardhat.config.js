...
const { LINEASCAN_API_KEY, MANTLE_RPC_URL,PRIVATE_KEY, NEON_RPC_URL,FILECOIN_RPC_URL, SCROLL_RPC_URL,RPC_URL,GORLIE_RPC_URL, CELO_RPC_URL, GNOSIS_RPC_URL, ETHERSCAN_API } = process.env;
module.exports = {
  solidity: {
    version: "0.8.19",
    settings: {
  ...
  apiKey: {
    ...
    mantleTest:'UQETFJNNDYBXRSGVT2WB6GZKMSA6TU36VT'
  },
  customChains: [
    {
