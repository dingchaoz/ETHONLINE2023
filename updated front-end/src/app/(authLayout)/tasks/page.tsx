...
export default function TasksPage() {
  ...
  const tasks = [
    ...
    {
      title:
        'How can we ensure that reinforcement learning agents generalize well from limited human feedback to unseen scenarios?',
      subTitle: 'Vote #5 | Ends in 3 days',
      isVoted: true,
      isOpen: true,
    },
    {
      title:
        'How can reinforcement learning algorithms effectively incorporate human feedback to accelerate learning in complex environments?',
      subTitle: 'Vote #4 | Ends in 3 days',
      isOpen: true,
      isVoted: voted,
    },
    {
      title: 'Explain RLHF',
      subTitle: 'Vote #3 | Sep 24, 2024 2:38 AM',
      isVoted: true,
    },
    {
      title:
        'What are the key challenges in designing reward models for reinforcement learning systems that rely on human feedback?',
      subTitle: 'Vote #2 | Sep 24, 2024 2:38 AM',
    },
    {
      title:
        'What techniques can be used to address the issue of sparse and potentially noisy human feedback in reinforcement learning?',
      subTitle: 'Vote #1 | Sep 24, 2024 2:38 AM',
    },
  ];
