    ...
    modalContent = (
      <div className='flex flex-col items-center justify-center py-10'>
        ...
        <p className='mx-auto mt-5 max-w-2xl text-base text-gray-500 dark:text-gray-400 sm:text-lg'>
          ...
          {step === 'group' && 'Setting up the group.'}
        </p>
      </div>
    );
  } else {
          ...
          <>
            <div>
              <div className='mb-2 block'>
                <Label htmlFor='group' value='Join a voting group' />
              </div>
              <TextInput id='group' required />
            </div>
            <Button
              className='ml-auto'
              onClick={() => {
      ...
      case 'setPassword':
        modalContent = (
          <>
            <div>
              <div className='mb-2 block'>
                <Label htmlFor='password' value='Set up a voting password' />
              </div>
